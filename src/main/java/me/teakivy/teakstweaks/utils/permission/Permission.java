...
public enum Permission {
    ...
    COMMAND_TAGGAME("command.taggame"),
    COMMAND_TAGGAME_GIVE("command.taggame.give", PermissionType.OP),
    COMMAND_TAGGAME_UNINSTALL("command.taggame.uninstall", PermissionType.OP),
