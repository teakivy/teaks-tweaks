...
public class TPACommand extends AbstractCommand {
    ...
    private int tpa(CommandContext<CommandSourceStack> context) {
        ...
        try {
            ...
            TPARequest request = new TPARequest(player, target, TPARequest.TPAType.TPA);
